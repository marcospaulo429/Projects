...
if __name__ == "__main__":
    ...
    imagem_redimensionada = imagem.resize(
        (largura_desejada, altura_desejada), Image.LANCZOS #Por favor use caso de erro: Image.ANTIALIAS
    )
